...
macro_rules! arbitrary_signed {
    ($u:ty, $bits:expr, $prng:ident) => {{
        let unsigned = arbitrary_unsigned!($u, $bits, $prng);
        if ($prng.rand() & 1) == 0 {
    ...
    fn type_former() -> TypeFormer<Self> {
        TypeFormer::Literal(Literal {
            corners: int_corners!(i8)
                ...
                .collect(),
            generate: |prng| arbitrary_unsigned!(Self, Self::BITS, prng),
            shrink: shrink_int!(),
        })
    }
...
impl Construct for i8 {
    ...
    fn type_former() -> TypeFormer<Self> {
        TypeFormer::Literal(Literal {
            ...
            generate: |prng| arbitrary_signed!(u8, Self::BITS, prng),
            shrink: shrink_int!(),
        })
    }
...
impl Construct for i16 {
    ...
    fn type_former() -> TypeFormer<Self> {
        TypeFormer::Literal(Literal {
            ...
            generate: |prng| arbitrary_signed!(u16, Self::BITS, prng),
            shrink: shrink_int!(),
        })
    }
...
impl Construct for i32 {
    ...
    fn type_former() -> TypeFormer<Self> {
        TypeFormer::Literal(Literal {
            ...
            generate: |prng| arbitrary_signed!(u32, Self::BITS, prng),
            shrink: shrink_int!(),
        })
    }
...
impl Construct for i64 {
    ...
    fn type_former() -> TypeFormer<Self> {
        TypeFormer::Literal(Literal {
            ...
            generate: |prng| arbitrary_signed!(u64, Self::BITS, prng),
            shrink: shrink_int!(),
        })
    }
...
impl Construct for i128 {
    ...
    fn type_former() -> TypeFormer<Self> {
        TypeFormer::Literal(Literal {
            ...
            generate: |prng| arbitrary_signed!(u128, Self::BITS, prng),
            shrink: shrink_int!(),
        })
    }
...
impl Construct for isize {
    ...
    fn type_former() -> TypeFormer<Self> {
        TypeFormer::Literal(Literal {
            ...
            generate: |prng| arbitrary_signed!(usize, Self::BITS, prng),
            shrink: shrink_int!(),
        })
    }
