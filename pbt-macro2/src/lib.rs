...
impl ::pbt::Pbt for Bool {
    ...
    fn deconstruct(self) -> ::pbt::reflection::Parts<::pbt::fields::Store> {
        match self {
            Self::False => ::pbt::reflection::Parts {
                fields: {
            ...
            Self::True => ::pbt::reflection::Parts {
                fields: {
                    let mut acc = ::pbt::fields::Store::new();
                    acc
                },
    ...
    #[inline]
    fn register(_registration: &mut ::pbt::registration::Registration<'_>) -> ::pbt::reflection::Variants<Self> {
        ::pbt::reflection::Variants::Algebraic(vec![
            ::pbt::reflection::Variant {
